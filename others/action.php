		...
		if (mysqli_num_rows($query) > 0) {
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				?>
				 ...
				 <li>
            <a class="image"><img src="product_images/<?php echo $product_image;?>"  style="width:100px;height:120px;" ></a>
            <div class="content">
			...
			<div class="cart-table table-responsive mb-40">
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					<td>
										...
										<a href="#" remove_id="<?php echo $product_id;?>" class="btn btn-danger remove"><span style="color:white;">remove</span></a>
										<a href="#" update_id="<?php echo $product_id;?>" class="btn btn-primary update"><span style="color:white;">update</span></span></a>
					...
					<td><input type="text" class="form-control qty" value="<?php echo $qty;?>" ></td>
				...
				?>
						...
						</table> </div>		<b class="net_total" style="font-size:20px;"> </b>
