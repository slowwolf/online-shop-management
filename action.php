						...
						'<div class="row">
								<div class="col-md-2">
									<div class="btn-group">
										...
										<a href="#" update_id="'.$product_id.'" class="btn btn-primary update"><span class="glyphicon glyphicon-ok-sign">Update</span></a>
									</div>
								</div>
								<input type="hidden" name="product_id[]" value="'.$product_id.'"/>
								<input type="hidden" name="" value="'.$cart_item_id.'"/>
								<div class="col-md-2"><img class="img-responsive" src="images/'.$product_image.'" style="width:100px; height:100px;"></div>
								<div class="col-md-2">'.$product_title.'</div>
								<div class="col-md-2"><input type="number" class="form-control qty" value="'.$qty.'" ></div>
