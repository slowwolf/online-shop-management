                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
										...
										<form action="insertpro.php" method="post" >
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">Production cost:</label>
                                                <div class="col-sm-10"><input type="text" name="cost" class="form-control" placeholder="$160.00"></div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Price:</label>
                                                <div class="col-sm-10"><input type="text" name="prize" class="form-control" placeholder="$160.00"></div>
                                            </div>
											<div class="form-group row"><label class="col-sm-2 col-form-label">quantity:</label>
                                                <div class="col-sm-10"><input type="text" name="qty" class="form-control" placeholder="$160.00"></div>
                                            </div>
											...
											<div class="form-group row"><label class="col-sm-2 col-form-label">image name:</label>
                                                <div class="col-sm-10"><input type="text" name="image" class="form-control" placeholder="image name"></div>
                                            </div>
