				...
				<div class="background-white">
					...
					<div class="invoice">
						...
						<div class="row invoice-table">
							...
							$product_query = "select  products.product_image,products.product_title,orders.product_id,orders.date,orders.qty,products.product_price,products.product_cost from orders INNER JOIN products on orders.product_id=products.product_id where orders.date between '$from' AND '$to' ";
