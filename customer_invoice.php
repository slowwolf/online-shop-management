...
<div id="page-wrapper">
		<div class="row">
				<div class="col-lg-12">
						<h1 class="page-header" style="text-align:center;background-color:#008B8B;padding:25px;color:white;">Your Invoice</h1>
...
<?php 
           ...
           include"db.php";         
					...
					$id = $_GET["id"];
						$date = date("Y-m-d");	
							$product_query = "SELECT orders.tnx_id,orders.order_id,orders.user_id,orders.product_id,orders.qty,orders.full_name,orders.city,orders.address,orders.email,products.product_title,products.product_price,products.product_image from orders INNER JOIN  products ON orders.product_id = products.product_id where user_id = $id ;";
...
?> </td></tr>
							...
							<div class="col-md-6 col-sm-6 col-xs-6 invoice-bill-to">
								...
								Phone Number: <?php echo $address; ?> <br>
