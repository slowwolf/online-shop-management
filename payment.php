	...
	# code...
		...
		if (mysqli_num_rows($query) > 0) {
			...
			for ($i=0; $i < count($product_id); $i++) { 
				...
				$sql = "INSERT INTO orders (user_id,product_id,tnx_id,qty,p_status,full_name,email,address,city,state,zip_code,payment_type,date) VALUES ('$cm_user_id','".$product_id[$i]."','".$tnx_id."','".$qty[$i]."','pending','$fullname','$email','$address','$city','$state','$zip','$paymenttype','$date')";
								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											...
											<a href="customer_invoice.php?id=<?php echo $cm_user_id;?>" class="btn btn-success btn-lg">View Invoice</a>
										</div>
