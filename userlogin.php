...
if($_POST) {		
	...
	if(empty($username) || empty($password)) {
		...
		if($result->num_rows == 1) {
			...
			// exists
			$mainSql = "SELECT * FROM user_info WHERE first_name = '$username' AND password = '$password' AND type= 0";
	...
	<div class="container">
		<div class="row vertical">
			<div class="col-md-5 col-md-offset-4">
				...
				<div class="panel panel-primary">
						<div class="panel-heading">
						<center>Copyright@Online shop  <br/>
	  Developed by- Jakia sultana </center>
						</div>
					</div>
